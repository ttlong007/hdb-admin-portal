...
import FormSenderInfo from '@/shared/logistics/shipment/create-edit/form-sender-info';
import FormPackageInfo from '@/shared/logistics/shipment/create-edit/form-package-info';
import FormShippingInfo from '@/shared/logistics/shipment/create-edit/form-shipping-info';
import FormRecipientInfo from '@/shared/logistics/shipment/create-edit/form-recipient-info';
import FormPaymentMethodInfo from '@/shared/logistics/shipment/create-edit/form-payment-method-info';
import FormNav, {
  FormParts,
} from '@/shared/logistics/shipment/create-edit/form-nav';
import { defaultValues } from '@/shared/logistics/shipment/create-edit/form-utils';
