...
const StepOne = dynamic(
  () =>
    import(
      '@/shared/appointment/appointment-list/appointment-form/data-time'
    ),
  {
    ssr: false,
  }
...
const StepTwo = dynamic(
  () =>
    import(
      '@/shared/appointment/appointment-list/appointment-form/services'
    ),
  {
    ssr: false,
  }
...
const StepThree = dynamic(
  () =>
    import(
      '@/shared/appointment/appointment-list/appointment-form/patient-information'
    ),
  {
    ssr: false,
  }
