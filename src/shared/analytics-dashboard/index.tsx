import WebsiteMetrics from '@/shared/analytics-dashboard/website-metrics';
import AccountRetention from '@/shared/analytics-dashboard/account-retention';
import Acquisition from '@/shared/analytics-dashboard/acquisition';
import ConversionRates from '@/shared/analytics-dashboard/conversion-rates';
import DeviceSessions from '@/shared/analytics-dashboard/device-sessions';
import GoalAccomplished from '@/shared/analytics-dashboard/goal-accomplished';
import StatCards from '@/shared/analytics-dashboard/stat-cards';
import TopTrafficSource from '@/shared/analytics-dashboard/top-traffic-source';
import UserMetrics from '@/shared/analytics-dashboard/user-metrics';
import PageMetrics from '@/shared/analytics-dashboard/page-metric';
