...
import LoggedInDevices from '@/shared/account-settings/logged-in-devices/table';
...
import AddTeamMemberModalView from '@/shared/account-settings/modal/add-team-member';
