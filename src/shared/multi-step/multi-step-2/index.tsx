...
import StepOne from '@/shared/multi-step/multi-step-2/step-1';
import StepTwo from '@/shared/multi-step/multi-step-2/step-2';
import StepThree from '@/shared/multi-step/multi-step-2/step-3';
import StepFour from '@/shared/multi-step/multi-step-2/step-4';
import StepFive from '@/shared/multi-step/multi-step-2/step-5';
import StepSix from '@/shared/multi-step/multi-step-2/step-6';
import Congratulations from '@/shared/multi-step/multi-step-2/congratulations';
